...
function BuiltInApp(name, url, origin) {
    this.name = name;
    this.url = url;
    this.origin = origin;
...
*/
  ...
  init: function() {
    ...
    this.services.registerMediator(
        "link.send",
    ...
    this.services.registerAgent("link.send", function() {
        return createAgent();
    });
  },
...
function installBuiltins() {
    this.builtins = [
        new BuiltInApp('Twitter',
                       require("self").data.url("apps/twitter.webapp"),
                       'https://www.twitter.com').install(),
        new BuiltInApp('Facebook', require("self").data.url("apps/facebook.webapp"),
                       'https://www.facebook.com').install()
    ]
}
