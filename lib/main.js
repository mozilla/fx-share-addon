...
*/
    ...
    let svc = this.services.get(contentWindow, "link.send");
    if (!svc)
  ...
  init: function() {
    ...
    this.window.document.getElementById("contentAreaContextMenu")
        .addEventListener("popupshowing", this._onContextMenuItemShowing.bind(this), false);
    ...
    this.services.registerMediator(
        "link.send",
        {url: require("self").data.url("ui/share/index.html"),
